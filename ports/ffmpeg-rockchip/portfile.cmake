...
if("rkmpp" IN_LIST FEATURES)
  ...
  string(APPEND OPTIONS " --disable-rkmpp")
endif()

if("rkrga" IN_LIST FEATURES)
  string(APPEND OPTIONS " --enable-rkrga")
  list(APPEND FFMPEG_PKGCONFIG_MODULES librga rockchip_rga)
else()
  string(APPEND OPTIONS " --disable-rkrga")
endif()
...
function(append_dependencies_from_libs out)
    ...
    # list(FILTER contents EXCLUDE REGEX "^rockchip_mpp$")
    if(VCPKG_TARGET_IS_WINDOWS)
